    ...
    useEffect(() => {
        const fetchBooks = async () => {
           ...
           const res = await axios.get(
            (cors({
                credentials: true,
                origin: `https://api.nytimes.com/svc/books/v3/lists/current/hardcover-fiction.json?api-key=qB07UhpMB0uZFElnA7CaUqxnkd4r7Hqf`
            }))
            ...
            fetch(`https://api.nytimes.com/svc/books/v3/lists/current/hardcover-fiction.json?api-key=qB07UhpMB0uZFElnA7CaUqxnkd4r7Hqf`, {
             headers: {
