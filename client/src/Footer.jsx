...
const Footer = () => {
  ...
  return (
    <React.Fragment>
        <div
          className="container-fluid bg-dark text-light footer pt-5 mt-6 ml-24 wow fadeIn"
          data-wow-delay="0.1s"
        >
          <div className="container py-3">
               <div className="row g-1">
                  <div className="col-lg-3 col-md-4">
                       <h4 className="section-title ff-secondary text-start font-bold text-primary fw-normal mb-2">
                          Company
                       </h4>
